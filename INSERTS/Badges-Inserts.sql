...
('Team HP +15% / Team Cost -300', 'Fix it!'), 
('Move Time +2 seconds / Team Cost -400', 'Fix it!'),
('Team RCV +35% / Team Cost -300', 'Fix it!'),
('No Skyfall Combos', 'Fix it!'),
('Team ATK +15% / Team Cost -300', 'Fix it!')