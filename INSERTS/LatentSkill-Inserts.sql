...
('Extend Move Time','Slightly extends time to move Orbs',1),
('Fire Damage Reduction','Slightly reduces damage from Fire Att. enemies',1),
...
('Improve All Stats','Slightly increases All Stats',2),
('Improved Attack','Slightly increases ATK',1),
('Improved HP','Slightly increses HP',1),
('Improved Healing','Slightly increases RCV',1),
